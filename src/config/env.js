...
const env = {
  ...
  EMAIL_PROVIDER: process.env.EMAIL_PROVIDER || 'mailjet',
  ...
  MAILJET_FROM_EMAIL: process.env.MAILJET_FROM_EMAIL || process.env.SMTP_FROM || 'no-reply@mean.mg',
  MAILJET_FROM_NAME: process.env.MAILJET_FROM_NAME || 'MEAN',
